...
class CatalogSearch_IndexController extends Omeka_Controller_AbstractActionController
{
  ...
  protected function _getForm($search = null)
  {
    ...
    $form->addElementToEditGroup(
     ...
     $form->addElementToEditGroup(
      'text', 'query_elementtouse',
      array(
        'id' => 'catalog-element-to-use',
        'value' => $search->query_elementtouse,
        'label' => __('Element to Use'),
        'description' => __(
          'The element that you want to search for (in Zotero array). For instance, Subject, Author, Title, etc.'
        ),
        'required' => true
      )
    );
