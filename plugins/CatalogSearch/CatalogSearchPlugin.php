  ...
  public function hookInstall() {
    ...
    $sql = "
      CREATE TABLE IF NOT EXISTS `$db->CatalogSearchSearch` (
        ...
        `query_elementtouse` tinytext COLLATE utf8_unicode_ci NOT NULL,
    ...
    $archive_grid->query_elementtouse = 'Subject';
    $archive_grid->save();
    ...
    $google_books->query_elementtouse = 'Subject';
    $google_books->save();
    ...
    $google_scholar->query_elementtouse = 'Subject';
    $google_scholar->save();
    ...
    $hathi_trust->query_elementtouse = 'Subject';
    $hathi_trust->save();
    ...
    $jstor->display = 1;
    $jstor->query_type = 1;
    $jstor->query_elementtouse = 'Subject';
    $jstor->save();
    ...
    $library_of_congress->query_elementtouse = 'Subject';
    ...
    $worldcat->query_elementtouse = 'Subject';
    $worldcat->save();
  }
